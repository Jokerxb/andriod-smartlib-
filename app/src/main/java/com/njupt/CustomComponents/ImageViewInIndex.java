 ...
 * 自定义ImageView视图
 */
public class ImageViewInIndex extends android.support.v7.widget.AppCompatImageView {
	...
	public ImageViewInIndex(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}

	public ImageViewInIndex(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}
